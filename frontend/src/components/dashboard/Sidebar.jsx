...
export default function Sidebar({ collapsed, onLogout }) {
  ...
  // Automatically switch content if user is in /company/settings/*
  const isSettings =
    ...
    >
      ...
      {isSettings && (
        <>
          ...
          {/* Section: Community Standards & Legal Policies */}
          {!collapsed && (
          ...
          <nav className="px-2 mt-2 flex flex-col gap-1">
            <NavItem
              ...
              to="/company/settings/terms"
              collapsed={collapsed}
            />
            <NavItem
              icon={<Shield className="w-4 h-4" />}
              label="Privacy policy"
              to="/company/settings/privacy"
              collapsed={collapsed}
            />
          </nav>
        </>
      ...
      {/* Logout stays at bottom in both modes */}
