      ...
      <div className="bg-white w-full max-w-3xl rounded-xl shadow-xl mt-10 overflow-hidden">
        ...
        <div className="px-5 py-3 border-t flex items-center justify-end gap-2">
          <button
            ...
            className="px-3 py-1.5 rounded-lg bg-red-500 text-white  text-sm hover:bg-red-400"
          >
            Reject
          </button>
          <button
            onClick={handleAccept}
            className="px-3 py-1.5 rounded-lg bg-green-500 text-white text-sm hover:bg-green-400"
          >
            Accept
          </button>
        </div>
